...
public abstract class Tree {
    ...
    /**
     * Conditional guard statements.
     */
    public static final int CONDITIONAL_GUARD = IF + 1;

    /**
     * Conditional guard.
     */
    public static final int CONDIONAL_GUARD_STATEMENTS = CONDITIONAL_GUARD + 1;

    /**
     * Expression statements, of type Exec.
     */
    public static final int EXEC = CONDIONAL_GUARD_STATEMENTS + 1;
     ...
     * Ternary operators
     */
    public static final int TERNARY_COND = PRINT + 1;
    ...
    public static class GuardClause extends Tree {
        ...
        public GuardClause(Expr condition, Tree trueBranch, Location loc) {
            super(CONDIONAL_GUARD_STATEMENTS, loc);
            this.condition = condition;
            this.trueBranch = trueBranch;
        }
    ...
    public static class Guard extends Tree {
        ...
        Type type;
        List<GuardClause> clauses;

        public Guard(Type type, List<GuardClause> clauses, Location loc) {
            super(CONDITIONAL_GUARD, loc);
